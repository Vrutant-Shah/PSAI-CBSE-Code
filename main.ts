namespace SpriteKind {
    ...
    export const things = SpriteKind.create()
    export const pave = SpriteKind.create()
    export const slowdown = SpriteKind.create()
    export const l2sprites = SpriteKind.create()
    export const l2car = SpriteKind.create()
    export const l2safe = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.entity, SpriteKind.entity, function (sprite, otherSprite) {
    ...
    if (x == 1) {
        ...
        game.showLongText("Now, We have discovered a way to stop accidents like this.", DialogLayout.Full)
        game.showLongText("To demonstrate this, The player will be driving a car with 'A' button and stop with 'B'", DialogLayout.Full)
        game.showLongText("And when the light at the corner turns red, stop and when the light turns green it Go!", DialogLayout.Full)
        game.showLongText("You are the Red Car!", DialogLayout.Full)
        ...
        PSAI = sprites.create(img`
            ...
            f f f f f f f f f f f f f f f f 
            `, SpriteKind.Player)
        PSAI.setPosition(24, 63)
        pause(500)
        ha.setVelocity(-30, 10)
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (selection == 1) {
        ...
        l2shooter3 = sprites.create(img`
            ...
            ................................................................................................................................................................
            `, SpriteKind.l2sprites)
        l2shooter.setPosition(78, 3)
        safe.setPosition(19, 88)
        l2shooter2.setPosition(45, 3)
        l2shooter3.setPosition(106, 2)
        controller.moveSprite(l2Zeal, 300, 200)
        l2Zeal.setStayInScreen(true)
        game.showLongText("There is an Earth Quake! you need to reach the safe zone without getting crushed by the boulders. ", DialogLayout.Full)
        game.showLongText("you have a flying car, Be Safe", DialogLayout.Full)
        l2Zeal.setPosition(131, 90)
        animation.runImageAnimation(
        l2back,
        [img`
            9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (selection == 1) {
        ...
        scene.setBackgroundImage(img`
            ...
            eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
            `)
        game.showLongText("During evening, on mountains tourists who are driving on the mountains, Meet with an accident as the cant see other people who are driving upwards as well as Downwards", DialogLayout.Full)
        ...
        Car2 = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.entity)
        Car1.setPosition(7, 95)
        Car1.setVelocity(70, 0)
        Car2.setPosition(150, 95)
        Car2.setVelocity(-70, 0)
        selection = 0
    }
    if (y == 1) {
        p.setVelocity(-20, -8)
    ...
    if (m == 1) {
        p2.setVelocity(30, -10)
    }
})
sprites.onOverlap(SpriteKind.l2car, SpriteKind.l2safe, function (sprite2, otherSprite2) {
    end = 1
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.l2car, function (sprite3, otherSprite3) {
    if (fan == 1) {
        l2Zeal.setPosition(139, 81)
    }
})
let end0 = 0
...
let amul: Sprite = null
let lol2: Sprite = null
let deron2 = 0
let Ti = 0
let ha2: Sprite = null
let lol: Sprite = null
...
let m = 0
let pcm = 0
let l2shooter3: Sprite = null
let l2shooter2: Sprite = null
let l2shooter: Sprite = null
let l2Zeal: Sprite = null
let safe: Sprite = null
let l2back: Sprite = null
let d = 0
let zeal: Sprite = null
let yash: Sprite = null
let deron: Sprite = null
let PSAI: Sprite = null
let y = 0
let ha: Sprite = null
let p: Sprite = null
let pavement: Sprite = null
let pavement2: Sprite = null
let x = 0
    ...
    if (d == 1) {
        if (deron.overlapsWith(ha)) {
            ...
            lol = sprites.create(img`
                ...
                f f f f f f f f f f f f f f f f 
                `, SpriteKind.Player)
            lol.setPosition(24, 63)
        }
        if (yash.overlapsWith(ha)) {
            sprites.destroy(ha)
            ha2 = sprites.create(img`
                ...
                . . . . . . . . . . . . . . . . 
                `, SpriteKind.Player)
            ha2.setPosition(50, 66)
            ha2.setVelocity(30, 12)
            Ti = 1
            deron2 = 1
        }
        if (yash.overlapsWith(p)) {
            sprites.destroy(p)
    ...
    if (deron2 == 1) {
        if (p.overlapsWith(pavement)) {
            ...
            lol2 = sprites.create(img`
                ...
                f f f f f f f f f f f f f f f f 
                `, SpriteKind.Player)
            lol2.setPosition(24, 63)
            deron2 = 0
        } else if (p.overlapsWith(pavement2)) {
            sprites.destroy(lol)
            lol2 = sprites.create(img`
                f f f f f f f f f f f f f f f f 
                f 7 7 7 7 7 7 7 7 7 7 7 7 7 7 f 
...
forever(function () {
    if (Ti == 1) {
        if (zeal.overlapsWith(ha2)) {
            ha2.setVelocity(50, 0)
        }
    }
})
forever(function () {
...
forever(function () {
    if (end == 1) {
        sprites.destroyAllSpritesOfKind(SpriteKind.l2sprites)
        sprites.destroyAllSpritesOfKind(SpriteKind.l2car)
        sprites.destroyAllSpritesOfKind(SpriteKind.l2safe)
        sprites.destroyAllSpritesOfKind(SpriteKind.Projectile)
        sprites.destroyAllSpritesOfKind(SpriteKind.Player)
        sprites.destroyAllSpritesOfKind(SpriteKind.pave)
        game.showLongText("Yay ! you won the game!", DialogLayout.Bottom)
        scene.setBackgroundImage(img`
            
